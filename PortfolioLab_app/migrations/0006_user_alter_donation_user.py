...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('PortfolioLab_app', '0005_donation_taken_timestamp'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='donation',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='PortfolioLab_app.user'),
        ),
    ]
